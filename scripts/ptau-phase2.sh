...
# Setup
snarkjs groth16 setup build/luhn16.r1cs build/pot15_final.ptau build/luhn_final.zkey

snarkjs zkey new build/luhn16.r1cs build/pot15_final.ptau build/luhn16_0000.zkey
...
# Verify zkey
snarkjs zkey verify build/luhn16.r1cs build/pot15_final.ptau build/luhn16_0003.zkey
...
snarkjs zkey verify build/luhn16.r1cs build/pot15_final.ptau build/luhn16_final.zkey